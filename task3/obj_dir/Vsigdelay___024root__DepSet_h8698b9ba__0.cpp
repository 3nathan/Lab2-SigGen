...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    vlSelf->__Vdly__sigdelay__DOT__rd_addr = vlSelf->sigdelay__DOT__rd_addr;
    if (vlSelf->rst) {
        vlSelf->__Vdly__sigdelay__DOT__rd_addr = 0U;
        vlSelf->__Vdly__sigdelay__DOT__rd_addr = 0U;
    } else {
        vlSelf->__Vdly__sigdelay__DOT__rd_addr = (0x1ffU 
...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__1(Vsigdelay___024root* vlSelf) {
    ...
    if (vlSelf->rd) {
        vlSelf->sigdelay__DOT____Vcellout__myRam__dout 
            = vlSelf->sigdelay__DOT__myRam__DOT__ram_array
    ...
    vlSelf->delayed_signal = vlSelf->sigdelay__DOT____Vcellout__myRam__dout;
}
...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__2(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    vlSelf->sigdelay__DOT__rd_addr = vlSelf->__Vdly__sigdelay__DOT__rd_addr;
}
