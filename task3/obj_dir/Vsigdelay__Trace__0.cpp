...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgSData(oldp+6,(vlSelf->mic_signal),9);
    bufp->chgSData(oldp+7,(vlSelf->delayed_signal),9);
    bufp->chgSData(oldp+8,(vlSelf->sigdelay__DOT__rd_addr),9);
    bufp->chgCData(oldp+9,((0xffU & (IData)(vlSelf->mic_signal))),8);
    bufp->chgCData(oldp+10,(vlSelf->sigdelay__DOT____Vcellout__myRam__dout),8);
}
